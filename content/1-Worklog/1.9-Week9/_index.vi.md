...
* Tìm hiểu yêu cầu dự án "Shared Expense Splitter" và các luồng chính của hệ thống.
* Rà soát kiến trúc frontend: cấu trúc thư mục, routing và tổ chức component.
* Thiết lập môi trường phát triển frontend và chạy dự án local.
* Xác định các màn hình UI cần có: Dashboard, Groups, Expenses, Settlements, Settings.
* Lên kế hoạch công việc frontend cho các tuần tiếp theo.
...
* **Kết quả chung:**
  * Hiểu rõ dự án "Shared Expense Splitter" và các luồng nghiệp vụ chính.
  * Rà soát kiến trúc frontend và thiết lập thành công môi trường phát triển local.
  * Chuẩn bị kế hoạch công việc frontend cho các tuần tiếp theo.

* **Kiến thức đã học:**
  * Hiểu kiến trúc tổng thể hệ thống: React frontend, Node.js backend và MongoDB.
  * Học cấu trúc dự án frontend, routing và cách tổ chức component.
  * Học cách frontend tích hợp với backend qua REST API.