...
![name](/fcaj-workshop-quangttse196220-fptu/images/5-Workshop/5.4-S3-onprem/s3-interface-endpoint1.png)
...
![service](/fcaj-workshop-quangttse196220-fptu/images/5-Workshop/5.4-S3-onprem/s3-interface-endpoint2.png)
...
![vpc](/fcaj-workshop-quangttse196220-fptu/images/5-Workshop/5.4-S3-onprem/s3-interface-endpoint3.png)

5. Chọn 2 subnets trong AZs sau: us-east-1a and us-east-1b

![subnets](/fcaj-workshop-quangttse196220-fptu/images/5-Workshop/5.4-S3-onprem/s3-interface-endpoint4.png)

6. Đối với Security group, chọn SGforS3Endpoint:

![sg](/fcaj-workshop-quangttse196220-fptu/images/5-Workshop/5.4-S3-onprem/s3-interface-endpoint5.png)

7. Giữ default policy - full access và click Create endpoint

![success](/fcaj-workshop-quangttse196220-fptu/images/5-Workshop/5.4-S3-onprem/s3-interface-endpoint-success.png)
